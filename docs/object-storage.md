...
```nohighlight
https://{{app-name}}.objects.frb.io/path/to/file.jpg?2024-05-05.1
https://{{app-name}}.objects.frb.io/path/to/file.jpg?2024-05-05.2
https://{{app-name}}.objects.frb.io/path/to/file.jpg?2024-05-06.1
```
